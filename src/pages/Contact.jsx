...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mensaje = `*Contacto - Miguel Sports*%0A%0A*Nombre:* ${formData.nombre}%0A*Email:* ${formData.email}%0A%0A*Mensaje:* ${formData.mensaje}`;
    
    const whatsappUrl = `https://wa.me/584247808491?text=${mensaje}`;
      ...
      <section className="bg-secondary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Contáct<span className="text-primary">anos</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-3xl font-bold text-secondary mb-6">
                Comunicación <span className="text-primary">Directa</span>
              </h2>
              <p className="text-gray-600 mb-8">
                Puedes contactarnos por cualquiera de estos medios. Nuestro equipo está disponible 
                para atenderte.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+58 424 780 8491</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">miguelbrit@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">@miguelsports</p>
                  </div>
                </div>
              </div>
            </div>
